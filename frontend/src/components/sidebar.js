...
import { faTachometerAlt, faExchangeAlt, faChartLine, faPiggyBank, faTags, faCog, faClipboard } from '@fortawesome/free-solid-svg-icons';
import './sidebar.css';
  ...
  return (
    <div className="sidebar">
      ...
      <nav className="nav">
        ...
        <li><Link to="/categorizer" className="nav-link"><FontAwesomeIcon icon={faClipboard} /> Categorizer</Link></li> {/* Added Categorizer */}
      </nav>
    </div>
  );
};
